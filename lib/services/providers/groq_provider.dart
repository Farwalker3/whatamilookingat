...
Return a JSON object with an "explanations" array of 3-8 objects. Each should describe a DIFFERENT thing visible or relevant. Get STRAIGHT TO THE POINT in the headline.

Format: {"explanations": [{"headline": "...", "summary": "...", "details": "...", "sources": ["camera","location","news","time"], "category": "landmark|event|sign|object|person|nature|vehicle|text|scene", "confidence": 0.0-1.0}]}

Rules:
- headline: one punchy sentence
- summary: 2-3 key detail sentences
- details: full paragraph with context
- Sort by relevance, most interesting first
- Use location/news context when relevant
