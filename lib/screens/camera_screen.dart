    ...
    return Padding(
      ...
      child: Container(
        ...
        child: const Column(
          children: [
            Text(
              'ðŸ‘ï¸ Point your camera at anything',
              style: TextStyle(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          ...
          'â€¢ Point your camera at anything\n'
          'â€¢ Get AI-powered explanations in real-time\n'
          'â€¢ Uses your location & local news for context\n'
          'â€¢ Multiple explanations per scene\n'
          'â€¢ Take photos to freeze & save explanations\n'
          'â€¢ Works offline with basic analysis\n\n'
